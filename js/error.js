...
const error3 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave "Has the Following Actor or Actress" blank.  If you intend to search for movies with ${actor} then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error4 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave "Movie's Genre" blank.  If you intend to search for ${genreT} movies then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error5 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave "Year Movie Released" blank.  If you intend to search for movies released in ${releaseYear} then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error6 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave "Movie's Genre" and "Has the Following Actor or Actress" blank.  If you intend to search for ${genreT} movies with ${actor} then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error7 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave "Year Movie Released" and "Has the Following Actor or Actress" blank.  If you intend to search for movies made in ${releaseYear} with ${actor} then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error8 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave "Movie's Genre" and "Year Movie Released" blank.  If you intend to search for ${genreT} movies made in ${releaseYear} then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error9 = `Sorry, you can only search for movies similar to "${similarTo}"  when you search for it seperate from all the preceding parameters.  If you intend to search for movies similar to "${similarTo}" then leave the other form entries blank.  If you intend to search for ${genreT} movies with ${actor} relased in ${releaseYear} then leave "Similar to this Movie" blank.<br><br> Finally, when using "Similar to this Movie", TMDB warns: This method only looks for other items based on genres and plot keywords. As such, the results found here are not always going to be 100%. Use it with that in mind.`
const error10 = `Sorry, no movies matched your search request.  This is likely because you tried to search for movies using too many parameters.  I could not find any ${genreT} movies made in ${releaseYear} with ${actor}.  Please remove or change one or two of these parameters and try again.`
const error11 = `Sorry, no movies matched your search request.  This is likely because you tried to search for movies using too many parameters.  I could not find any ${genreT} movies made in ${releaseYear}.  Please remove or change one or two of these parameters and try again.`
const error12 = `Sorry, no movies matched your search request.  This is likely because you tried to search for movies using too many parameters.  I could not find any movies made in ${releaseYear} with ${actor}.  Please remove or change one or two of these parameters and try again.`
const error13 = `Sorry, no movies matched your search request.  This is likely because you tried to search for movies using too many parameters.  I could not find any ${genreT} movies with ${actor}.  Please remove or change one of these parameters and try again.`
